...
OneDriveUser::OneDriveUser(const QString &userId, const QDateTime &updatedTime,
                           const QString &userName, int count)
    : d_ptr(new OneDriveUserPrivate(userId, updatedTime, userName, count))
{
}
...
OneDriveUser::Ptr OneDriveUser::create(const QString &userId, const QDateTime &updatedTime,
                                       const QString &userName, int count)
{
    return OneDriveUser::Ptr(new OneDriveUser(userId, updatedTime, userName, count));
}
...
int OneDriveImage::account() const
{
    Q_D(const OneDriveImage);
    return d->account;
}
                                     ...
                                     const QString &userName)
{
    ...
    OneDriveUser::Ptr user = OneDriveUser::create(userId, updatedTime, userName);
